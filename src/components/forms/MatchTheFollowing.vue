    ...
    <div class = "questionboxcard1">
        <b-card class="card" header-tag="header">
            <template #header>
                ...
                <b-row align-h="end">
                    <b-button style="margin-top:1%" variant="outline-secondary" @click="$emit('delete-form')"
              ...
              <div class="inputanswers" v-for="(input,k) in inputs" :key="k">  
                <div class="questionrows">
                    <b-input-group class="inputgrp">                              
                        ...
                        <b-button @click="remove(k)" v-show="k || ( !k && inputs.length >= 1)" variant="outline-secondary" class="deletebutton">
                            <i class="fas fa-trash"></i>
                        </b-button>                                                   
                    </b-input-group> 
                </div>                 
              ...
              <!-- <div class="inputanswers" v-for="(input,k) in inputs" :key="k" >   -->
                <div class="inputanswers questionrows">
                    <b-input-group class="inputgrp">                                  
                        ...
                        <b-form-input @click="addsideA(k)" v-show="k || ( !k && inputs.length >= 0)" class="input">Side A</b-form-input>                        
                        <b-form-input @click="addsideB(k)" v-show="k || ( !k && inputs.length >= 0)" class="input">Side B</b-form-input>                                                                           
                    </b-input-group> 
                </div>                 
              <!-- </div> -->
            ...
            <b-row>
                    ...
                    <!-- <b-input-group style="padding-left:70%"> -->
                            ...
                            <b-button-group class="m-2 mt-4 p-0">                    
                                    ...
                                    <b-dropdown variant="primary" text = "Add" right style="margin-bottom:1%">       
                                        <b-dropdown-item>
                                            <b-form-checkbox 
                                            id="checkbox-1"
                                            v-model="status" 
